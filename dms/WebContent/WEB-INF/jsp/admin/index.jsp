...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="#">能力规范文稿管理系统</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">H-ui</a> 
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			<dt><i class="Hui-iconfont">&#xe616;</i> 提案列表<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a data-href="article-list.html" data-title="提案列表" href="javascript:void(0)">提案列表</a></li>
			</ul>
		</dd>
	</dl>
	
		<dl id="menu-product">
			<dt><i class="Hui-iconfont">&#xe620;</i> 提案批审<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<li><a data-href="article-list2.html" data-title="推荐(专委会)" href="javascript:void(0)">推荐(专委会)</a></li>
					<li><a data-href="article-list2.html" data-title="备案(行业分会)" href="javascript:void(0)">备案(行业分会)</a></li>
					<li><a data-href="article-list2.html" data-title="立案(研究会)" href="javascript:void(0)">立案(研究会)</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-comments">
		...
		<dl id="menu-admin">
			...
			<dd>
				<ul>
					<li><a data-href="admin-role.html" data-title="用户管理" href="javascript:void(0)">用户管理</a></li>
	...
	<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active">
					<span title="我的桌面" data-href="article-list.html">我的桌面</span>
					<em></em></li>
		</ul>
	</div>
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="<%=request.getContextPath()%>/resources/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
